...
if recommender.load_model():
    ...
    training_status = {"status": "no_model", "message": "No trained model found. Please train first."}
...
def recommend(user_id):
    ...
    # The new get_recommendations always returns scores
...
def train():
    ...
    def train_worker():
        ...
        try:
            ...
            # We use the train.py logic or call the recommender methods directly
...
def status():
    ...
    # Load eval metrics from evaluation_report.json
